...
contract Proposal12Test is SimulateProposalBase {
    function test_proposal_12() public onlyFork {
        ...
        calldatas[1] = abi.encodeWithSignature(
            ...
            0xd4b8604b9673338cc909d8b9db941cd8ba68b45c061abb04f952957a2be9216f,    // Merkle root
            4960000000002000000000                                                 // Amount distributed - 0xc9a95ee2964caee600
        );
        ...
        assertEq(distributor.merkleRoot(), 0xd4b8604b9673338cc909d8b9db941cd8ba68b45c061abb04f952957a2be9216f);
        assertEq(prot.balanceOf(address(distributor)), 4960000000002000000000);
