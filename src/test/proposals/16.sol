...
import { SimulateProposalBase } from "../SimulateProposalBase.t.sol";
...
contract Proposal16Test is SimulateProposalBase {
    function test_proposal_16() public onlyFork {
        ...
        address target = 0xBa29eea93d3a518C6b333865aD6256379D5560bD;
        bytes memory data = abi.encodeWithSelector(Proposal16.execute.selector);
