...
contract Proposal34Test is SimulateProposalBase {
    function test_proposal_34() public onlyFork {
        ...
        calldatas[4] = abi.encodeWithSignature(
            ...
            0x323fced1f4ecea98740b0510954027cadcc8c76f512869814db840f79212b29e, // Merkle root
            900000000006000000000 // Amount distributed - 0x30ca024f99e130bc00
        );
        ...
        assertEq(
            ...
            0x323fced1f4ecea98740b0510954027cadcc8c76f512869814db840f79212b29e
        );
        assertEq(prot.balanceOf(address(distributor)), 900000000006000000000);
