...
contract Proposal38Test is SimulateProposalBase {
    function test_proposal_38() public onlyFork {
        ...
        calldatas[4] = abi.encodeWithSignature(
            ...
            0x11d94f8d6e0f7336692d8df855cac7b1b0525fa4de9243922bcaf51f1ce5302c, // Merkle root
            899999999995000000000 // Amount distributed - 0x30ca024f97518a0e00
        );
        ...
        assertEq(
            ...
            0x11d94f8d6e0f7336692d8df855cac7b1b0525fa4de9243922bcaf51f1ce5302c
        );
        assertEq(prot.balanceOf(address(distributor)), 899999999995000000000);
