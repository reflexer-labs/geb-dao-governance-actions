...
contract Proposal42Test is SimulateProposalBase {
    function test_proposal_42() public onlyFork {
        ...
        uint[3] memory amounts = [uint(913 ether), 888 ether, 830 ether];
        ...
        calldatas[3] = abi.encodeWithSignature(
            ...
            0x75174f8c92ed1586df12b9f02820df1d2c7f9dbe22c2da07affb874d2cea42b5, // Merkle root
            930000000001000000000 // Amount distributed - 0x326a57b8a5ddad3600
        );
        ...
        assertEq(
            ...
            0x75174f8c92ed1586df12b9f02820df1d2c7f9dbe22c2da07affb874d2cea42b5
        );
        assertEq(prot.balanceOf(address(distributor)), 930000000001000000000);
