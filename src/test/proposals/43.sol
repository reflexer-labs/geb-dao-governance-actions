...
contract Proposal43Test is SimulateProposalBase {
    function test_proposal_43() public onlyFork {
        ...
        uint[3] memory amounts = [uint(1627 ether), 1627 ether, 1711 ether];
        ...
        calldatas[3] = abi.encodeWithSignature(
            ...
            0xad909b5cf1a464e4298d45d6753010d545d47186f92b9fa0026d0d6ba645d9be, // Merkle root
            870000000000000000000 // Amount distributed - 0x2f29ace68addd80000
        );
        ...
        assertEq(
            ...
            0xad909b5cf1a464e4298d45d6753010d545d47186f92b9fa0026d0d6ba645d9be
        );
        assertEq(prot.balanceOf(address(distributor)), 870000000000000000000);
