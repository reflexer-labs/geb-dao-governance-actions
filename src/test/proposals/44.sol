...
contract Proposal44Test is SimulateProposalBase {
    function test_proposal_44() public onlyFork {
        ...
        address[4] memory receivers = [
            address(0xb5Ed650eF207e051453B68A2138D7cb67CC85E41),
        ...
        uint distributionTotal = 930000000000000000000; // Amount distributed - 0x326a57b8a619480000
        ...
        calldatas[4] = abi.encodeWithSignature(
            ...
            0xe1a2714f46e6b5b07ccf20565a0753e87a31267871cd754190c44e361cf7a101, // Merkle root
            distributionTotal
        );
        ...
        // testing balances
        for (uint i; i < receivers.length; ++i) {
            // first receiver should have the amount minus the distribution total
            ...
            if (i == 0) {
                ...
                expectedBalance = prevBalances[i] + amounts[i];
            }

            assertEq(prot.balanceOf(receivers[i]), expectedBalance);
        }
        ...
        assertEq(
            ...
            0xe1a2714f46e6b5b07ccf20565a0753e87a31267871cd754190c44e361cf7a101
        );
        assertEq(prot.balanceOf(address(distributor)), distributionTotal);
