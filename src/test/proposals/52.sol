...
contract Proposal52Test is SimulateProposalBase {
    function test_proposal_52() public onlyFork {
        ...
        uint[3] memory amounts = [uint(3235 ether), 3235 ether, 1941 ether];
        ...
        calldatas[3] = abi.encodeWithSignature(
            ...
            0xa9bbfab287bbcf2f353e2ead24f09621d5ccc5260c89bf5929c10d06c1e61d3f, // Merkle root
            900000000000000000000 // Amount distributed - 0x30ca024f98b72aca00
        );
        ...
        assertEq(
            ...
            0xa9bbfab287bbcf2f353e2ead24f09621d5ccc5260c89bf5929c10d06c1e61d3f
        );
