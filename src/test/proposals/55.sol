...
contract Proposal55Test is SimulateProposalBase {
    function test_proposal_55() public onlyFork {
        ...
        uint[3] memory amounts = [uint(2124 ether), 2124 ether, 637 ether];
        ...
        calldatas[3] = abi.encodeWithSignature(
            ...
            0x17f2fc62134ffb69414a9cadd7164ce3f549d4cfd02a6b459abcc24258b57176, // Merkle root
        ...
        assertEq(
            ...
            0x17f2fc62134ffb69414a9cadd7164ce3f549d4cfd02a6b459abcc24258b57176
        );
